...
<head>
    <meta charset="utf-8"/>
    <title>Anxiety Screening - MindWell</title>
...
<div class="page">
    ...
    <div class="header"><h1>💫 Anxiety Screening</h1><p>Understand your anxiety symptoms and severity</p></div>
    <div class="card">
        ...
        <form id="assessmentForm" action="${pageContext.request.contextPath}/student/assessment/submit" method="post">
            <input type="hidden" name="assessmentType" value="anxiety">
            <div class="question-container" data-question="1">
                <div class="question-title">How often do you feel anxious?</div>
                <div class="options">
                    <div class="option"><input type="radio" id="q1_1" name="q1" value="5" required><label for="q1_1" class="option-label">Never</label></div>
                    <div class="option"><input type="radio" id="q1_2" name="q1" value="4"><label for="q1_2" class="option-label">Rarely</label></div>
                    <div class="option"><input type="radio" id="q1_3" name="q1" value="3"><label for="q1_3" class="option-label">Sometimes</label></div>
                    <div class="option"><input type="radio" id="q1_4" name="q1" value="2"><label for="q1_4" class="option-label">Often</label></div>
                    <div class="option"><input type="radio" id="q1_5" name="q1" value="1"><label for="q1_5" class="option-label">Always</label></div>
                </div>
            </div>
            <div class="question-container" data-question="2" style="display:none;">
                <div class="question-title">Do you experience physical symptoms like racing heart or trembling?</div>
                <div class="options">
                    <div class="option"><input type="radio" id="q2_1" name="q2" value="5"><label for="q2_1" class="option-label">Not at all</label></div>
                    ...
                    <div class="option"><input type="radio" id="q2_5" name="q2" value="1"><label for="q2_5" class="option-label">Constantly</label></div>
                </div>
            </div>
            <div class="question-container" data-question="3" style="display:none;">
                <div class="question-title">How much do anxious thoughts interfere with your daily activities?</div>
                <div class="options">
                    <div class="option"><input type="radio" id="q3_1" name="q3" value="5"><label for="q3_1" class="option-label">Not at all</label></div>
                    <div class="option"><input type="radio" id="q3_2" name="q3" value="4"><label for="q3_2" class="option-label">Slightly</label></div>
                    <div class="option"><input type="radio" id="q3_3" name="q3" value="3"><label for="q3_3" class="option-label">Moderately</label></div>
                    <div class="option"><input type="radio" id="q3_4" name="q3" value="2"><label for="q3_4" class="option-label">Significantly</label></div>
                    <div class="option"><input type="radio" id="q3_5" name="q3" value="1"><label for="q3_5" class="option-label">Severely</label></div>
                </div>
            </div>
            <div class="question-container" data-question="4" style="display:none;">
                <div class="question-title">Can you control your anxiety?</div>
                <div class="options">
                    <div class="option"><input type="radio" id="q4_1" name="q4" value="5"><label for="q4_1" class="option-label">Completely</label></div>
                    <div class="option"><input type="radio" id="q4_2" name="q4" value="4"><label for="q4_2" class="option-label">Mostly</label></div>
                    <div class="option"><input type="radio" id="q4_3" name="q4" value="3"><label for="q4_3" class="option-label">Somewhat</label></div>
                    <div class="option"><input type="radio" id="q4_4" name="q4" value="2"><label for="q4_4" class="option-label">Barely</label></div>
                    <div class="option"><input type="radio" id="q4_5" name="q4" value="1"><label for="q4_5" class="option-label">Not at all</label></div>
                </div>
            </div>
            <div class="question-container" data-question="5" style="display:none;">
                <div class="question-title">How would you rate your anxiety severity?</div>
                <div class="options">
                    <div class="option"><input type="radio" id="q5_1" name="q5" value="5"><label for="q5_1" class="option-label">No anxiety</label></div>
                    <div class="option"><input type="radio" id="q5_2" name="q5" value="4"><label for="q5_2" class="option-label">Mild</label></div>
                    <div class="option"><input type="radio" id="q5_3" name="q5" value="3"><label for="q5_3" class="option-label">Moderate</label></div>
                    <div class="option"><input type="radio" id="q5_4" name="q5" value="2"><label for="q5_4" class="option-label">Severe</label></div>
                    <div class="option"><input type="radio" id="q5_5" name="q5" value="1"><label for="q5_5" class="option-label">Very severe</label></div>
                </div>
            </div>
            <div class="buttons">
